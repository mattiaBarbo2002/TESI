...
# [fine - 79001] [79000 - 75001] 
# [75000 - 74001] 
# [74000 - 73901] [73900 - 73801] [73800 - 73701] [73700 - 73601] [73600 - 73501] [73500 - 73001]
# [73000 - 72501] [72500 - 72001] 
# [72000 - 71501] [71500 - 71001] 
# [71000 - 70501] [70500 - 70001]
# [70000 - 69501] [69500 - 69001]
# [69000 - 68501] [68500 - 68001]
# [68000 - 67501] [67500 - 67001]
# [67000 - 66501] [66500 - 66001]
# [66000 - 65501] [65500 - 65001]
# [65000 - 64501] [64500 - 64001]
# [64000 - 63001]
# [63000 - 62001] 
# [62000 - 61001] 
# [61000 - 60001] 
...
if __name__ == "__main__":
    ...
    if RIGA_INIZIO is not None and RIGA_FINE is not None:
        ...
        print(f"RIGHE: {inizio_idx + 1} a {fine_idx} | Tot: {len(df_input)}")
    ...
    if righe_c > 0:
        print(f"Aggiunte {righe_c} serie a {os.path.basename(csv_complete)}")
    else:
        print(f"Nessuna serie completa da salvare.")
        
    if righe_inc > 0:
        print(f"Aggiunte {righe_inc} serie a {os.path.basename(csv_incomplete)}")
    else:
        print(f"Nessuna serie incompleta da salvare.")
