...
def pretrain_encoders(
    ...
    datasetS2 = Singlemodal_Loader(train_data_OPT_IDS, traindir, patch_size, n_images2, n_channels2, 'OPT')
    ...
    datasetS1 = Singlemodal_Loader(train_data_SAR_IDS, traindir, patch_size, n_images1, n_channels1, 'SAR')
